function [v1, v2, I1, I2, u1, u2, g1, g2] = izhikevich_two(t,v0,u0,i0,a,b,c,d,tau,gbar,ddelta,vr)
    ...
    for i = 2:length(t)
        dg_dt1 = -1 * g1(i-1) / tau + gbar * ddelta(i-1);
        g1(i) = g1(i-1) + dt * dg_dt1;
        dg_dt2 = -1 * g1(i-1) / tau + gbar * ddelta(i-1);
        g2(i) = g1(i-1) + dt * dg_dt2;
